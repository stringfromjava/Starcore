...
final class Controls {
    ...
    // Volume (just pressed)
	  ...
	  private inline function get_VL_UP_JUST_PRESSED():Bool return justPressed('vl_up');
	  private inline function get_VL_DOWN_JUST_PRESSED():Bool return justPressed('vl_down');
	  private inline function get_VL_MUTE_JUST_PRESSED():Bool return justPressed('vl_mute');
